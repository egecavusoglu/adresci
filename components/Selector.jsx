...
const Selector = (props) => {
  return (
    <div className="mx-auto  mt-8 bg-gray-50 w-5/6 rounded-lg border-2 border-gray-300 grid  grid-cols-1 sm:grid-cols-3 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-200">
